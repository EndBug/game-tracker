...
export default class R6OPWiki extends Command {
  constructor() {
    super(getConfig('op', {
      ...
      examples: {
        'recruitsas BandltlsMyMaln': 'Displays Recruit SAS stats for `BandltlsMyMaln` by searching the user in the `uplay` category.',
        'gridlock Truman xbl': 'Displays Gridlock stats for `Truman` by searching the user in the `xbl` category.',
        'nokk @DiscordUser': 'Displays Nøkk stats for the mentioned user, if they linked their account.',
