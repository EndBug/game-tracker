...
export default class VoteCMD extends Commando.Command {
  ...
  async run(msg: Commando.CommandoMessage) {
    const embed = new RichEmbed()
      ...
      .addField('Hot to vote', 'Head to the [vote page](https://discordbots.org/bot/475421235950518292/vote) and click the \'Vote\' button; if you\'re not already logged in with Discord it\'ll ask you that first.')
