...
export default class OWCompWiki extends Command {
  constructor() {
    super({
      ...
      details:
        'To specify the player, enter their battletag/GamerTag/PSN ID. You can also mention them and, if they linked their account to this bot, it will display their stats. If left blank, the bot will try to show your profile (if you `ow link`ed it).',
      format:
        '{battletag#1234 | GamerTag | PSN ID | @mention} [platform: (pc | xbl | psn)]',
      examples: [
