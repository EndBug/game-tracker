  ...
  constructor() {
    super(
      getConfig('op', {
        ...
        details:
          'Specify the operator to show by writing their name. Every operator can be written in lowercase with no spaces or dots, e.g.: "Recruit SAS" = "recruit_sas".\nYou can find codes for supported operators here: <https://game-tracker.js.org/#/r6/r6_names?id=operators>',
        examples: {
          'recruit_sas BandltlsMyMaln':
